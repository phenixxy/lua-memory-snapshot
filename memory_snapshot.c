...
// type: -1 (global state), 4 (string), 5 (table), 6 (function), 7 (userdata), 8 (proto)
typedef void(*snapshot_callback)(const void *o, int type, size_t size, const char *name, const char *desc, const char *value, const void *parent);
